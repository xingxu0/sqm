...
for i in range(5, 21, 3):
	...
	for j in range(times):
		os.system("python policy_dynamic.py 3 %d 0.10 90 %d"%(i, 1 if j>0 else 0))
...
ax2.set_xlabel("Number of Premium Users (good and bad)")
ax.set_xlabel("Number of Premium Users (good and bad)")
plt.tight_layout()
plt.savefig("vary_premium_user_good_bad.png")