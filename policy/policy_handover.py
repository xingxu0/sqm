...
for i in range(max(leave_time)): #common.time):
	...
	common.get_downgrade_fraction(r3, admitted_sqm, df_sqm)
	...
	common.get_downgrade_fraction(r3, admitted_sqm2, df_sqm2)
	...
	common.get_downgrade_fraction(r3, admitted_sqm3, df_sqm3)
