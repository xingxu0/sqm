...
for i in range(300, 1800, 300):
	...
	for j in range(times):
		if stair:
			os.system("python policy_dynamic_qoe.py 1 10 0.10 90 1 %d.trace %d"%(pid, i))
		else:
			os.system("python policy_dynamic_qoe_real_no_stair.py 1 10 0.10 90 1 %d.trace %d"%(pid, i))
...
plt.tight_layout()
plt.savefig("vary_duration.png_%d.png"%(stair))
