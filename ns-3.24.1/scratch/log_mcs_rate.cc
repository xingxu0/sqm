...
Simulator::Schedule(Seconds(3), &print_mcs);
Simulator::Schedule(Seconds(4), &print_mcs);
Simulator::Schedule(Seconds(5), &print_mcs);
Simulator::Schedule(Seconds(6), &print_mcs);
Simulator::Schedule(Seconds(7), &print_mcs);
Simulator::Schedule(Seconds(8), &print_mcs);
Simulator::Schedule(Seconds(9), &print_mcs);
