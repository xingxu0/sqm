...
def get_data_from_pcap(f):
	os.system("captcp throughput -s 5 -i -f 1.1 -o temp_plot %s"%(f))
...
x = []
y = []
x2,y2 = get_data_from_pcap("static/dynamic_weight_0.pcap")
x1,y1 = get_data_from_pcap("dynamic/dynamic_weight_0.pcap")
...
ax.legend(["dynamic", "static", "base"], 1)
ax2.legend(["dynamic", "static"], 4)
savefig("plot_ir.png")
